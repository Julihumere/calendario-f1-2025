...
export default function Cards({
  ...
  return (
    <div className="w-full mx-8 h-auto relative flex flex-col items-center justify-between rounded-2xl max-[1240px]:mx-2 max-[500px]:w-full max-[500px]:h-[300px]">
      <div
      ...
      />
      <div
        style={{ backgroundColor: active !== id ? "#101828" : "transparent" }}
